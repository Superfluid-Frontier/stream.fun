  ...
  return (
    <div className="flex flex-col min-h-[100dvh]">
      <main className="flex-1">
        <section className="min-w-full py-12 md:py-24 lg:py">
          <div className="container px-4 md:px-6 space-y-10 xl:space-y-16">
            <div className="grid max-w-[1300px] mx-auto gap-4 px-4 sm:px-6 md:px-10">
              <div className="max-w-4xl">
                ...
                <br/>
                <p className=" max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400 flex">
                  Our intuitive platform allows you to create and deploy your
                  own ERC20 token without any coding knowledge. Get started
                  today and take control of your digital assets.
                </p>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">
                  Why use our no-code token deployer?
                </h2>
                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                  Our platform offers a range of benefits to make your token
                  deployment process seamless and efficient.
                </p>
              </div>
            </div>
            <div className="mx-auto grid items-start gap-8 sm:max-w-4xl sm:grid-cols-2 md:gap-12 lg:max-w-5xl lg:grid-cols-3">
              <div className="grid gap-1">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Our no-code solution allows you to deploy your token in
                  minutes, without the need for extensive development.
                </p>
              </div>
              <div className="grid gap-1">
                <div className="flex items-center gap-3">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Our platform streamlines the token deployment process,
                  allowing you to focus on your project&apos;s growth.
                </p>
              </div>
              <div className="grid gap-1">
                <div className="flex items-center gap-3">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Our platform ensures your token is deployed securely, with
              ...
              <div className="grid gap-1">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  ...
                  wallets, making it accessible to a wider audience.
                </p>
              </div>
              <div className="grid gap-1">
                <div className="flex items-center gap-3">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Our platform is designed to handle high traffic and
                  transaction volumes, ensuring your token can grow with your
                  project.
                </p>
              </div>
              <div className="grid gap-1">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  ...
                  from our team and other users when you need it.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container space-y-12 px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                  Get answers to the most common questions about our no-code
              ...
              <Collapsible className="grid gap-4">
                ...
                <CollapsibleContent>
                  <div className="text-sm text-gray-500 dark:text-gray-400">
                    An ERC20 token is a standard for fungible tokens on the
                    Ethereum blockchain. It defines a common set of rules that
                    all ERC20 tokens must adhere to, making them interoperable
                    with each other and with other Ethereum-based applications.
                  </div>
                </CollapsibleContent>
              </Collapsible>
            </div>
